...
RT_EXPORT rt_s da_postgres_statement_execute(struct da_statement *statement, const rt_char8 *sql);

RT_EXPORT rt_s da_postgres_statement_get_row_count(struct da_statement *statement, rt_un *row_count);
